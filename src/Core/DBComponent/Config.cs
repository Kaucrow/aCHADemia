...
namespace aCHADemia.Core.DBComponent
{
    /// <summary>
    ...
    public static class Config
    {
        ...
        static Config()
        {
            ...
            if (tomlTable.TryGetValue("db-postgres", out var postgresEntry) && postgresEntry is TomlTable postgresTable)
            {
            ...
            if (tomlTable.TryGetValue("db-mysql", out var mysqlEntry) && mysqlEntry is TomlTable mysqlTable)
            {
